    ...
    <div className={cn("py-28")}>
      ...
      <div className={cn("grid grid-cols-4 pt-6")}>
        ...
        <div className={cn("col-span-1 pl-6 relative")}>
          <div
            className={cn(
              "bg-blue-300 w-14 text-sm text-blue-900 font-bold relative p-1"
            )}
          >
            NEWS{" "}
            <div
              className={cn(
                "bg-blue-900 w-6 text-white text-xs absolute left-11 top-5 text-center p-1"
              )}
            >
              TV
            </div>{" "}
        ...
        <div className={cn("col-span-1 pl-6")}>
          <div
            className={cn(
              "bg-blue-300 rounded-full w-11 h-11 relative font-bold p-2 text-center text-white"
            )}
          >
            One{" "}
            <div
              className={cn(
                "bg-blue-800 rounded-full w-6 h-6 absolute text-xs -top-1 left-9 p-1 text-white text-center"
              )}
            >
              TV
            </div>
